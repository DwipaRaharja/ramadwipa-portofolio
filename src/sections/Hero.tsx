...
const Hero = () => {
  return (
    <section className="relative min-h-screen overflow-hidden px-4 pt-24 pb-12 sm:px-6 sm:pb-24 lg:px-8 lg:pb-32">
      {/* decoration circle */}
      <DecorativeGlow className="top-36 -right-24 size-48 sm:right-0 sm:size-56 lg:top-40 lg:right-50 lg:size-64" />
      <DecorativeGlow className="top-120 -left-14 size-48 sm:left-0 sm:size-56 lg:top-105 lg:left-64 lg:size-64" />

      {/* main content about me */}
      <motion.div className="mx-auto flex w-full max-w-7xl flex-col items-center">
        <div className="bg-primary w-fit rounded-full px-5 py-1.5 sm:px-6">
        ...
        <div className="relative z-10 mt-3 text-center sm:mt-4">
          <h1 className="lg:text-shadow-heading text-3xl leading-tight font-bold text-shadow-lg sm:text-4xl md:text-5xl lg:text-7xl">
            I'm <span className="text-primary">Ramadwipa,</span>
            <br />
            <span className="text-4xl leading-tight font-medium sm:text-5xl md:text-6xl lg:text-8xl">
        ...
        <div className="relative z-20 mx-auto mt-10 grid w-full max-w-7xl grid-cols-1 items-center justify-items-center gap-8 sm:gap-10 lg:-mt-4 lg:grid-cols-[1fr_auto_1fr] lg:justify-items-stretch lg:gap-8">
          ...
          <div className="order-2 w-full max-w-sm text-center lg:order-1 lg:max-w-xs lg:justify-self-end lg:text-left">
          ...
          <div className="order-1 size-[clamp(14rem,65vw,20rem)] overflow-hidden rounded-full border-2 border-gray-300 bg-[linear-gradient(180deg,#F0F4FE_30%,#3C63C5_100%)] lg:order-2 lg:size-92" />

          {/* third content (social media)*/}
          <div className="order-3 max-w-full justify-self-center lg:justify-self-start">
